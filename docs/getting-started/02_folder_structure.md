...
### `carbon.mod.json`
The first thing Carbon Loader reads. Contains your mod's name, version, and other info. See <a href="03_carbon_mod_json.md">getting-started/03_carbon_mod_json.md</a> for full details.
