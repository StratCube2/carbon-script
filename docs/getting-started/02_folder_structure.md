...
### `carbon.mod.json`
The first thing Carbon Loader reads. Contains your mod's name, version, and other info. See <a href="./03_carbon_mod_json/">getting-started/03_carbon_mod_json/</a> for full details.
